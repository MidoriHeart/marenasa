...
class MarenasaPreguntas extends MActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_marenasa, pregunta, respuesta,imagen', 'required'),
    ...
    {
        $b = Yii::app()->baseUrl;
        return "<div class='imagenCarrusel' style='background-image: url($b/uploads/marenasapreguntas/imagen/$nombre)'></div>";
    }
    ...
    public function adminSearch()
    {
        ...
        (
            ...
            (
                ...
                (
                    'name'=>'imagen',
                    'type' => 'raw',
                    'value'=>'MarenasaPreguntas::model()->getImagenYcm($data->imagen)',
                    'filter' => ''
                )
            )
        );
     ...
     public function extraOptions() {
         ...
         public function js() {
           ...
           $cs->registerScriptFile($baseUrl.'/js/ycm/preguntasFrecuentes/cutImage.js');
       ...
       public function css() 
    {
        ...
        $cs->registerCssFile($baseUrl.'/css/ycm/preguntasFrecuentes/cutImage.css');
        $cs->registerCssFile($baseUrl.'/css/preguntasFrecuentes/preguntasFrecuentesYcm.css');
    }
